...
FREQ_FSKID_BIT1 = 3900
FREQ_FSKID_BIT0 = 4100
...
class SSTV(object):
    ...
    def gen_freq_bits(self):
        ...
        """
        #preamble for 500 ms to remove the fade in issue
        yield FREQ_VIS_START, 500

        if self.vox_enabled:
            for freq in (FREQ_VIS_START, FREQ_BLACK, FREQ_VIS_START, FREQ_BLACK, FREQ_WHITE, FREQ_BLACK, FREQ_WHITE, FREQ_BLACK):
                yield freq, 100
